...
origin, the corresponding local field obeys \(\partial_\mu\phi(x)=0\).  Under
the standard assumptions of a unique conformally invariant vacuum and cluster
decomposition, this is the identity representation.  The hypothesis is stated
because a direct sum with a decoupled topological or superselection sector can
otherwise contain additional zero-energy central operators.
