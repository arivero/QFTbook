...
in Section~\ref{sec:cft-source-functionals-ward-contacts}.  The chiral
...
transformation data under nonlinear chiral vector fields.  A Virasoro primary
is a local operator \(\phi\) whose stress-tensor singular part is exactly
\begin{equation}
  T(z)\phi(0)
  =
  \frac{h}{z^2}\phi(0)
...
On a punctured disc, define the holomorphic modes by
\begin{equation}
  L_n
  =
