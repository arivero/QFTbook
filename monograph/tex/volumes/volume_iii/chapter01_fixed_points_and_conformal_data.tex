...
normalization of \(W_\ast\) is the Euclidean effective-action normalization.
...
\[
  ...
  \right\},
\]
up to the local counterterms that define the source chart.  In an abstract CFT
the displayed integral is replaced by the corresponding renormalized source
