...
& Chapter~\ref{ch:curved-perturbative-algebraic-qft} constructs interacting
fields order by order from microcausal functionals, time-ordered products,
relative \(S\)-matrices, and local renormalization maps.  This is the
Hollands--Wald pAQFT control level
