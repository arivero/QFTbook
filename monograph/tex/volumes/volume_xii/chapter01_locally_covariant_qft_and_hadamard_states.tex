...
Chapters~\ref{ch:locally-covariant-qft-hadamard}--\ref{ch:curved-microlocal-spectrum-condition}.
...
The following status matrix is the volume spine.  It is conservative by
design: a row is upgraded only by adding the missing physical construction or
theorem, not by adjoining more formal notation.
\begin{center}
\small
...
\textbf{Claim family} & \textbf{Status in this volume} & \textbf{What is
