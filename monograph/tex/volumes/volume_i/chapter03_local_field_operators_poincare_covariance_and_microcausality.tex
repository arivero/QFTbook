...
invariance gives the covariance law of
...
graded exchange relation of
Proposition~\ref{prop:wightman-adjacent-spacelike-exchange}.  The continuity
of the smeared matrix elements then extends these identities from tensor
products of test functions to the corresponding Wightman distributions.
