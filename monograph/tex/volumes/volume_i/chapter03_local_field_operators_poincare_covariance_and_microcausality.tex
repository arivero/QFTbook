...
The figure is schematic in one space dimension. The condition is the
set-theoretic one written above: every pair of points, one from each support,
has spacelike separation.
