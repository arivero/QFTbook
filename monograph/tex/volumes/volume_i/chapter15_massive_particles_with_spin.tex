...
\begin{tikzpicture}[scale=0.95,>=Stealth]
  ...
  \draw[purple!80!black,very thick,->]
    (-3.65,-0.16).. controls (-3.25,-0.82) and (-2.75,-0.82) .. (-2.35,-0.16);
  \node[purple!80!black] at (-3.0,-1.05) {closed loop};
  ...
  \draw[red!75!black,very thick,->]
    (2.25,-0.15).. controls (2.75,-0.85) and (3.25,-0.85) .. (3.75,-0.15);
  \node[red!75!black] at (3.0,-1.08) {\(2\pi\)};
  \draw[orange!80!black,very thick,->]
    (3.75,0.15).. controls (3.25,0.85) and (2.75,0.85) .. (2.25,0.15);
  \node[orange!80!black] at (3.0,0.98) {\(4\pi\)};
\end{tikzpicture}
\end{center}
...
boost change \(u_A{}^\sigma(p)\) by a momentum-dependent little-group
rotation and leave physical matrix elements unchanged.
