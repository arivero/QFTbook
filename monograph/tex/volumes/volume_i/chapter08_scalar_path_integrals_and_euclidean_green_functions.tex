...
At fixed \(\Lambda\), the field theory is an ordinary quantum-mechanical system
with finitely many coordinates.  Choose a time partition
\[
...
Chapter~\ref{ch:hamiltonian-evolution-time-sliced-path-integrals}.  If the
Trotter limit exists for the regulated Hamiltonian \(H_\Lambda\), then
\[
  \lim_{N\to\infty}
  K_{\Lambda,N}(\varphi_f,t_f;\varphi_i,t_i)
  =
