...
The following proposition records the precise finite-dimensional regulator
class for which the Trotter theorem may be imported.

\begin{proposition}[Finite-dimensional Schr\"odinger regulators inherit Trotter--Kato]
