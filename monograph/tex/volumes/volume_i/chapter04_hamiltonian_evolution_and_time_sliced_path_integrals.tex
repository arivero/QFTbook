...
Thus polynomial oscillator potentials with positive leading part have a unique
self-adjoint closure from the natural differential operator core, and the
Trotter formula applies to that closure.
