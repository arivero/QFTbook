...
Figure~\ref{fig:classical-lagrangian-hamiltonian-data} organizes the regular
classical data used in the time-sliced construction: the Legendre map from
Lagrangian data to Hamiltonian data and the two equivalent forms of the
equations of motion.
