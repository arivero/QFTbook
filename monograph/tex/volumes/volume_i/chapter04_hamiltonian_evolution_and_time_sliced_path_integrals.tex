...
This theorem is a theorem about bosonic Schr\"odinger quantum mechanics, and
by extension an important model for constructive scalar field theories when a
positive Euclidean measure exists.  It is not a general definition of the QFT
path integral.  Fermionic fields use Berezin integration over Grassmann
...
\(\theta\)-angle generally make the Euclidean weight complex.  The general
lesson carried forward is therefore not that every QFT path integral is a
Borel probability measure, but that every use of path-integral notation must
state the mathematical object being used: a measure, an oscillatory integral,
a Berezin functional, a gauge-fixed/BV construction, a lattice regularization,
or a formal perturbative expansion.
...
observable algebra.  Formal traces per unit volume, or traces with the
