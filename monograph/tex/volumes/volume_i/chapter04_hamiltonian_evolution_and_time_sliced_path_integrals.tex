...
Thus in ordinary Euclidean quantum mechanics the continuum path integral is
not merely the formal limit of time-sliced Lebesgue products.  Under the
hypotheses of Theorem~\ref{thm:wiener-feynman-kac-qm}, it is a genuine
Wiener expectation on continuous paths, multiplied by the potential weight.
