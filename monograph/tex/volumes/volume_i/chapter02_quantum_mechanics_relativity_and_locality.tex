...
\(P^\mu\), so their spectral projections commute.  This strong commutativity
is stronger than the formal infinitesimal relation
...
shadow of the joint functional calculus.  The spectrum condition is exactly
the assertion that this joint spectral measure is supported in
\(\overline V_+\).
\end{proof}
