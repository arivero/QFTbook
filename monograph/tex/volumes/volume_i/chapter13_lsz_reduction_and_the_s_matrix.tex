...
\[
  F_{\rm out}=f_1\odot\cdots\odot f_m,
  \qquad
  F_{\rm in}=g_1\odot\cdots\odot g_n
\]
...
\[
  \langle F_{\rm out},S F_{\rm in}\rangle_{\mathcal F_s(\Hilb_1)}
  =
  \langle \Omega_{\rm out}F_{\rm out},
  \Omega_{\rm in}F_{\rm in}\rangle_{\Hilb}.
\]
...
\(\langle F_{\rm out},SF_{\rm in}\rangle_{\mathcal F_s(\Hilb_1)}\) is obtained
