...
\[
  ...
  =
  \ee^{\mp\ii\theta(k)}\epsilon_\mu^\pm(k)+c_\pm(k)k_\mu .
\]
The phase is the dual helicity-frame phase, and the term proportional to
\(k_\mu\) is the representative change generated by the null-translation part
of the little group.
