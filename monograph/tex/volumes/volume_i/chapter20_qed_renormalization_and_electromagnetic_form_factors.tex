...
the present gamma-matrix convention.  They are related to the more common
Dirac--Pauli notation by \(F=F_1\) and \(G=F_2\), after converting the Gordon
identity to the mostly-plus gamma-matrix convention used here.
