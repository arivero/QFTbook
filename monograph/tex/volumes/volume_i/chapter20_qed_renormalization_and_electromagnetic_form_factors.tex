...
\begin{lemma}[One-loop QED vacuum polarization in explicit-coupling coordinates]
\label{lem:qed-one-loop-vacuum-polarization}
...
Lemma~\ref{lem:qed-one-loop-vacuum-polarization}, the one-loop vertex
correction gives
\[
