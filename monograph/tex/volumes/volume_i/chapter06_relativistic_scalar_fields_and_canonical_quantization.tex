...
Lagrangian path integral formally starts from
\(\int[D\phi]\exp(\ii S[\phi]/\hbar)\), whose measure requires a regulator
before it becomes a construction. This chapter develops the canonical
