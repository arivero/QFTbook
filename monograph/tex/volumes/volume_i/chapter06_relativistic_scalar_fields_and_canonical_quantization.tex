...
For the rest of this chapter set \(\hbar=1\). Factors of \(\hbar\) can be
restored by rescaling the oscillator variables in the standard way.
...
Hamiltonian selects the oscillator normalization.
...
finite scalar multiple of the identity. Subtracting this scalar gives the
renormalized free Hamiltonian
\[
...
\[
  U(a,\Lambda)\widehat\phi(x)U(a,\Lambda)^{-1}
  =
