...
\]
This distribution has spacelike support.  The graded sign in the locality
bracket is therefore part of the structure fixed by spin and positivity, rather
than an optional convention.  The corresponding spin-statistics theorem-level
