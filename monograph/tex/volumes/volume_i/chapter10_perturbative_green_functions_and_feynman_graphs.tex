...
\begin{proposition}[Tree-level amputated Euclidean four-point kernel]
\label{prop:tree-level-amputated-euclidean-four-point-kernel}
...
\begin{proof}
Multiply the leading connected Green function in
