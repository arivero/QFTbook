...
Figure~\ref{fig:normalized-correlator-component-selection} records the component
selection in that proof: vacuum components cancel against \(Z_\Lambda[0]\), and
surviving components contain external insertions.
