...
\(\hat\phi(x)\Omega\) have invariant mass separated from \(m\) by the assumed
gap.
...
\[
  P_1\hat\phi_{f^{(T)}}\Omega=P_1\hat\phi_f\Omega
\]
...
\[
  \Psi_T=\hat\phi_{f_1^{(T)}}\hat\phi_{f_2^{(T)}}\Omega .
\]
For fixed \(\Delta T\),
\[
\begin{aligned}
...
\[
  \langle\Psi_T,\Psi_{T+\Delta T}\rangle
  -
  \langle\hat\phi_{f_1}\Omega,\hat\phi_{f_1}\Omega\rangle
  \langle\hat\phi_{f_2}\Omega,\hat\phi_{f_2}\Omega\rangle
  \longrightarrow 0,
\]
...
\[
  P_1\frac{\dd}{\dd t}B_{j,t}(h_j)\Omega=0 .
\]
