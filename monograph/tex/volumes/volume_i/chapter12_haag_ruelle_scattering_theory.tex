...
sector is captured by such asymptotic particle data.  This is an additional
dynamical theorem or hypothesis.  For nontrivial interacting massive local
Wightman theories in four spacetime dimensions, full asymptotic completeness is
presently an open problem rather than a known consequence of the axioms.  Proofs
exist only in restricted model classes, notably constructive or integrable
models in lower spacetime dimensions and related weakened-locality settings.
