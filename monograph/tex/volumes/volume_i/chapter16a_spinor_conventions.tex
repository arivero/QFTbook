...
classical spinor components with the graded adjoint, the dagger reverses the
order of the two odd fields and the same matrix identity gives
\((\bar\psi\gamma^\mu\psi)^\dagger=-\bar\psi\gamma^\mu\psi\).  In a quantum
field theory, the local current is a renormalized composite
operator-valued distribution; normal ordering is the free-field/Fock
realization of this adjoint convention, not a general definition of the
coincident product.
\end{definition}
...
matrix test and for Grassmann-odd classical spinor fields with the graded
adjoint.
...
spinor fields with the graded adjoint.  Multiplication by \(\ii\) gives the
Hermitian current normalization.  The quantum statement concerns the
renormalized composite current as an operator-valued distribution; a
normal-ordered free current is one representation-dependent model of that
composite field.
