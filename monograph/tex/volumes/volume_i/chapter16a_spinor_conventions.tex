...
of the section is not merely notational: signs in the Dirac adjoint, current
...
\begin{proof}
The Clifford relation follows from the same Pauli algebra as in three
dimensions.  With \(\epsilon^{01}=+1\), the two nonzero traces are
\[
...
indices vanish by anticommutation and tracelessness.
\end{proof}
