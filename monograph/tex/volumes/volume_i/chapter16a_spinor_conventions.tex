...
At the fixed metric \(\eta=\operatorname{diag}(-,+,+,+)\), the
Wess--Bagger-type matrices used here are related to the Weinberg-compatible
matrices by a finite chiral phase change.  The matrix
\[
