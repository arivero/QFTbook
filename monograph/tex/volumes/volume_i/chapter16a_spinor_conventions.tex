...
\[
  ...
  -\beta\gamma^\mu .
\]
Thus \(\bar\psi\gamma^\mu\psi=\psi^\dagger\beta\gamma^\mu\psi\) is
anti-Hermitian in the even finite-dimensional model, while
\(\ii\bar\psi\gamma^\mu\psi\) is Hermitian.  The operator-valued current uses
the same adjoint convention after products at coincident points have been
represented in the chosen regulator or by normal ordering.
\end{definition}
