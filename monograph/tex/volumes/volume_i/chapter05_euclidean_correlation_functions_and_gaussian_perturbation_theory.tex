...
\begin{proposition}[Sign of the Wick-rotated weight]
\label{prop:wick-rotated-mechanical-weight}
...
\begin{proof}
Along the rotated contour \(\dd t=-\ii\,\dd\tau\) and
...
\]
\begin{corollary}[Finite gap after choosing the finite local term]
\label{cor:derivative-oscillator-finite-gap-counterterm}
