...
\]
and let the spectrum of \(\widehat H-E_0\) on \(\ket0^\perp\) lie in
\([\Delta,\infty)\) with \(\Delta>0\).  Spectral calculus gives
\[
...
\(\bra0\widehat q(0)\widehat q(\tau)\ket0\) when \(\tau<0\). Thus
\[
  G(\tau)
  =
  \begin{cases}
    \bra0\widehat q(\tau)\widehat q(0)\ket0, & \tau>0,\\
    \bra0\widehat q(0)\widehat q(\tau)\ket0, & \tau<0.
  \end{cases}
\]
