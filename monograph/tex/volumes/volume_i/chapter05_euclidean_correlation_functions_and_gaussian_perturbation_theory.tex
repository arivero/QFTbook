...
\[
  ...
  \right\rangle_0 .
\]
\paragraph{Vacuum components in normalized two-point functions.}
...
\paragraph{Local counterterm for the derivative interaction.}
...
After the counterterm choice
\(C=\Lambda/(4\pi)+C_{\mathrm{fin}}\), the
first energy gap is
\[
  \omega_1
  =
