...
\begin{lemma}[Lower-half-plane continuation from the spectral theorem]
\label{lem:qm-spectral-euclidean-boundary-value}
...
\begin{lemma}[Euclidean long-time projection onto the vacuum]
\label{lem:euclidean-long-time-vacuum-projection}
