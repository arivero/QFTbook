...
and distribution theory.  The proof uses three ingredients: polynomial tube
bounds give tempered boundary values; equality of the two boundary
distributions on the real edge removes the analytic obstruction normal to the
edge; and the resulting local holomorphic representatives glue in the envelope
of holomorphy of the two wedges.  The QFT-specific burden in this chapter is
the verification of these hypotheses from the spectral condition and local
commutativity.
