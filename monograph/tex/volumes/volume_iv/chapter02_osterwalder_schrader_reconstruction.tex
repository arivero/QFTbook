...
exactly the hypotheses that remove this failure mode.\footnote{The analytic
gap was isolated after the first OS reconstruction paper; see, for example,
A.~Klein and L.~J.~Landau, ``Singular perturbations of positivity preserving
semigroups via path space techniques,'' J. Funct. Anal. \textbf{20} (1975)
44--82, and ``Construction of a unique self-adjoint generator for a symmetric
local semigroup,'' J. Funct. Anal. \textbf{44} (1981) 121--137.  The lesson
for reconstruction is not a defect of reflection positivity itself, but the
need for a separate theorem making the positive-time translations bounded and
strongly continuous on the OS quotient.}
\end{remark}
