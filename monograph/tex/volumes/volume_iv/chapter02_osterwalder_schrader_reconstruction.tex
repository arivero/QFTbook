...
the linear-growth condition \eqref{eq:os-linear-growth-condition}.  By the
...
\(U(t,0)=\ee^{-\ii tH}\).  Spatial translations and rotations preserve the
...
representations on the reconstructed Hilbert space.
Proposition~\ref{prop:os-ii-analytic-route-to-boundary-package} gives the
