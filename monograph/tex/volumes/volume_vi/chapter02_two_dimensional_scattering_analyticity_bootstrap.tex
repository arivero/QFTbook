...
The following elementary verification is recorded because this block is the
basic unitary zero-pole pair used in diagonal bootstrap formulae.  Products
of such blocks place zeros and poles at prescribed locations.  The bootstrap
construction problem is to choose the product and possible CDD factors so
that unitarity, crossing, physical-strip pole assignments, residue signs, and
asymptotic bounds hold simultaneously.
