...
\begin{definition}[Regular two-body \(R\)-system]
\label{def:regular-two-body-r-system}
A regular two-body \(R\)-system consists of species spaces \(V_a\) and
...
Definition~\ref{def:factorized-scattering-bootstrap-data} are satisfied
