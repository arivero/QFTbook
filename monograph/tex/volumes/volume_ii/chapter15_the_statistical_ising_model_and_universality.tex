...
fixed point.  When the limiting fixed point is rotation and scale invariant
with the usual stress-tensor properties, this fixed point is the Ising
conformal field theory.  At criticality \(Z_\sigma(L,T_c)\) may be chosen
proportional to \(L^{-2\Delta_\sigma}\), so the rescaled spin insertions have
finite correlators.
