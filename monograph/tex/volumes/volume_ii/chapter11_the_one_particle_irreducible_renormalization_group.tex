...
Euclidean version is convex when defined exactly, so spontaneous symmetry
breaking must be read from the infinite-volume limit and from the effective
potential before convexification. The Wilsonian action,
