...
process continues.  The cutoff-removal limit then requires an unbounded
sequence of independent local coefficients.
  ...
  \begin{tikzpicture}[>=Stealth,x=1cm,y=1cm,every node/.style={font=\small}]
    ...
    \begin{scope}[shift={(11.1,0)}]
      ...
      \node[red!70!black,align=center] at (0,-1.35)
        {one-loop eight-point\\\(\phi^8\), then \(\phi^{10},\ldots\)};
    \end{scope}
  \end{tikzpicture}
  }
