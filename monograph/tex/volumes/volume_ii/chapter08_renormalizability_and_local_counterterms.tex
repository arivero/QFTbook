...
next order, a logarithmic momentum-dependent contribution.  Thus the field
strength counterterm is part of the closed renormalizable coordinate chart even
though its coefficient vanishes at one loop in \(\phi^4\) theory.  The
four-point 1PI function has a logarithmic divergence.  These divergences are
canceled by
\[
  \delta m^2\phi^2,
  \qquad
