...
axioms.  The stronger fixed-\(t\) cut-plane theorem used in dispersion
relations requires more.  One must prove that the primitive four-point germ
and the relevant retarded commutator representation extend far enough, after
LSZ pole separation, to give a first-sheet \(s\)-plane domain at fixed
\(t\), with only the stated right- and left-hand cuts and with controlled
boundary growth.  That additional step is the Lehmann--Martin/Jin--Martin
domain theorem, not a restatement of primitive tube analyticity.
