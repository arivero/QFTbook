...
shell in a compatible spacetime arrangement.  Its invariant location is
...
positive Feynman parameters.  The physical sheet is not the same notion as the
physical region of real external momenta: it is a branch of the analytic
continuation.  Positivity of the Feynman parameters distinguishes a
...
Coleman--Thun singularities in two-dimensional factorized scattering are a
standard nonperturbative setting where this mechanism appears.
