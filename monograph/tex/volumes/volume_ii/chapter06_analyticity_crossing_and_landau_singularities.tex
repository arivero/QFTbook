...
In the symmetric case represented by the vector sketch, the closure condition
fails when
\[
  M_1,M_2<\sqrt2\,m .
\]
The contour can then be deformed and the amplitude is regular at the
corresponding point. When
\[
  M_1,M_2>\sqrt2\,m ,
\]
the on-shell vectors can be arranged with positive Feynman parameters. The
Landau equations then determine a special value of \(M_3\), or equivalently a
special value of \(P_3^2=-M_3^2\), at which the triangle graph has a
first-sheet singularity.
