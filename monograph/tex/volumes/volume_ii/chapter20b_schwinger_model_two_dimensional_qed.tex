...
Figure~\ref{fig:schwinger-model-exact-solution} summarizes the exact solution
chain used in the chapter: the massless Dirac-Abelian gauge system is
bosonized, the gauge representative is integrated out, and the remaining scalar
field carries the Schwinger mass.
