...
bound-state equations, and light-front regularization.  A nonperturbative
construction of four-dimensional QCD is a separate problem; the
two-dimensional model is one of the cleanest places where the relation between
gauge constraints, color-singlet Hilbert-space sectors, and a computable meson
spectrum can be studied without appealing to perturbative \(S\)-matrix
intuition.
