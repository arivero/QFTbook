...
Figure~\ref{fig:jets-measurement-irc-flow} places the generalized
\(k_T\)-algorithm definition inside the infrared-safe observable map: physical
final states are clustered, measured by \(F(X)\), and compared under soft and
collinear refinements.
