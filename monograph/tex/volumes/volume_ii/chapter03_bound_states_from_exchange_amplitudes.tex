...
\]
For \(x\to+\infty\), choose the outgoing solution normalized by
\[
  \psi_k^{\mathrm{out}}(x)
  \sim
...
Analytically continue to \(k=\ii\alpha\), \(\alpha>0\). Then
\[
...
For two identical scalar particles of mass \(m\) in four dimensions, write
\[
  z=\cos\theta,
  \qquad
  s=E^2 .
