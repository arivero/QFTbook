...
the two-derivative quadratic operator, schematically
\(\mathcal O_{2,2}=\phi\,\Box\phi\), in the same self-energy convention
used above.  Its 1PI Taylor coefficient at \(k^2=\mu^2\) is
\[
