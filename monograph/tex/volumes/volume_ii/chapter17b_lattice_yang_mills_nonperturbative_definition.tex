...
\(\operatorname{tr}(t^a t^b)=\frac12\delta^{ab}\).  Let
\[
  \Lambda_{a,L}
  =
...
\end{equation}
Here \(g_0\) is the lattice coupling parameter.  The integrand
...
\(\beta(a)=2N/g_0(a)^2\), so that dimensionless lattice observables scale in
