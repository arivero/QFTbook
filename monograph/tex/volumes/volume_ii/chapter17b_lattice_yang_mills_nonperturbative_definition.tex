...
\begin{proposition}[Exact finite-basis GEVP extraction]
\label{prop:lattice-glueball-gevp-exact}
Assume that, for \(n=1,\ldots,m\), the overlap matrix
...
\begin{proof}
Under the stated finite-basis hypothesis,
\[
