...
functional in the sense of Definition~\ref{def:source-functional-log-status}
and the BPHZ status declaration
in Chapter~\ref{ch:volume-ii-subdivergences-forest-formulas}.  They are formal
