...
\begin{description}
  ...
  second-sheet poles.  The input is a previously constructed amplitude,
  unitarity, crossing domain, spectral condition, and analyticity
  assumptions.  This gives a conditional analytic continuation of amplitudes.
...
\begin{enumerate}
  ...
  \item Massive amplitudes plus analyticity hypotheses give partial waves,
  dispersion relations, and resonance poles.
