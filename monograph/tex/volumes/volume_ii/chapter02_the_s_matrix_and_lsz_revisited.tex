...
Fix a stable scalar particle of mass \(m>0\). Let \(\Hilb_1\subset\Hilb\) be
its one-particle Hilbert space, and let
\[
  \mathcal F_s(\Hilb_1)
  =
...
Generalized momentum states on the positive mass shell
\[
  \Sigma_m^+
  =
