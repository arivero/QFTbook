...
\]
insertion of a complete set of states gives the factorization. More precisely,
project the spectral resolution in the intermediate channel onto the isolated
mass-\(M_B\) one-particle subspace, and collect all other intermediate states
into terms analytic at \(P^2=-M_B^2\). The pole part is
\[
\begin{aligned}
  \widetilde G_4(k_1,k_2,k_3,k_4)
  &\sim
...
create and annihilate the stable composite state. The sign and the factor
\(-\ii/(P^2+M_B^2-\ii0)\) are the scalar Feynman propagator convention in the
mostly-plus metric.
