...
\(\mathcal Z_\Lambda\).  Rewriting this identity in terms of insertion
distributions supplies the signs:
\[
  \begin{aligned}
  G^\Lambda_{A_1\cdots A_r}(x_1,\ldots,x_r;J)
  &=
  ...
  \end{aligned}
\]
For the bare derivative attached to a partition \(\pi\),
\[
  \begin{aligned}
  \left.
  \frac{\delta^{|\pi|}W_{\Lambda_0}[J,\eta_0]}
  ...
  \end{aligned}
\]
Thus a term indexed by \(\pi\) carries the factor
\((-1)^r(-1)^{|\pi|}=(-1)^{r-|\pi|}\).  The finite-regulator partition formula
is therefore
\begin{equation}
  \begin{aligned}
  G^\Lambda_{A_1\cdots A_r}(x_1,\ldots,x_r;J)
