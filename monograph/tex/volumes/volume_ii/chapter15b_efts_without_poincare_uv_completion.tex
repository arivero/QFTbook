...
\end{enumerate}
When these data are supplied, the limiting continuum QFT is not merely an
approximation to the lattice system.  It is the scaling-limit object.
\end{definition}
...
does not merely approximate the continuum QFT; it constructs it.
