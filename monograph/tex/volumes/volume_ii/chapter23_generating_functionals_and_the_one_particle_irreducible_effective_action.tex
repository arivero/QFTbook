...
\begin{proposition}[Euclidean convexity at finite regulator]
\label{prop:volume-ii-euclidean-convexity-finite-regulator}
...
Proposition~\ref{prop:volume-ii-euclidean-convexity-finite-regulator}.  It supplies
...
Proposition~\ref{prop:volume-ii-euclidean-convexity-finite-regulator} identifies the
...
Proposition~\ref{prop:volume-ii-euclidean-convexity-finite-regulator}, \(K\) is
