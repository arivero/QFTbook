...
Assume \(N_c=N_f=3\), ignore the anomalous axial \(U(1)\), and treat the
CFL datum of Definition~\ref{def:qcd-cfl-condensate-datum} as the
source-selected order in an infinite-volume dense state.  The physical
