...
to \(A_{\rm em}\).  The axial chemical potential in
\eqref{eq:cme-source-normalized} is a hydrostatic source parameter.  A
conserved axial charge in a sector with nonzero \(\epsilon F_VF_V\) would
require additional anomaly-free data.
\end{remark}
...
\begin{proposition}[Hydrostatic Chern--Simons variation]
\label{prop:hydrostatic-cs-variation}
...
\begin{proposition}[Canonical entropy divergence with anomaly]
\label{prop:canonical-entropy-divergence-anomaly}
Let
\[
  T^{\mu\nu}
  =
