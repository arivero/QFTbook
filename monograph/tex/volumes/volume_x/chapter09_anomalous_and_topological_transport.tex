...
\eqref{eq:cme-source-normalized} is a hydrostatic source parameter; it should
not be confused with a conserved axial charge in a sector where
\(\epsilon F_VF_V\) is nonzero.
\end{remark}
