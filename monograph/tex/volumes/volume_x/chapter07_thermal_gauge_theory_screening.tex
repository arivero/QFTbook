...
\begin{lemma}[Thermal susceptibility integrals]
\label{lem:thermal-susceptibility-integrals}
...
\begin{proposition}[One-loop origin and coefficient of the Debye mass term]
...
Lemma~\ref{lem:thermal-susceptibility-integrals}, so
\begin{equation}
  \chi_{\rm Dirac}^{ab}
  =
  4T_R\delta^{ab}
