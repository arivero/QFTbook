...
Proposition~\ref{prop:susy-holomorphic-decoupling}.  Thus the nonzero
superpotential in the runaway range is not inferred from Seiberg duality; it
is a chiral \(F\)-term result whose direct semiclassical anchor and
decoupling assumptions are displayed separately.
