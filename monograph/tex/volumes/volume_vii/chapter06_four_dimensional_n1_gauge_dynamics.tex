...
\eqref{eq:sqcd-sconfining-superpotential} have the same engineering
dimension and \(R\)-charge, and the prefactor makes
\(W_{\mathrm{conf}}\) a dimension-three, \(R\)-charge-two chiral
superpotential.
\end{proposition}
...
\[
  (N_c+1)\frac2{N_c+1}=2 .
\]
Classically, \(\dim M=2\) and \(\dim B_i=\dim\widetilde B^j=N_c\).
Both \(B_iM^i{}_j\widetilde B^j\) and \(\det M\) therefore have dimension
\[
  2N_c+2=2(N_c+1).
\]
Since \(\Lambda_h^{2N_c-1}\) has dimension \(2N_c-1\) and zero
