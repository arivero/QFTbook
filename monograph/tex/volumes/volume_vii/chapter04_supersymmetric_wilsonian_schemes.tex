...
group action or BV gauge complex, a projection
...
spurion transformations, and are local at scale \(\Lambda\).  The usual
selection-rule arguments are consequences of these three conditions.
...
used in exact dynamics.  This is the infrastructure needed for theorem-level
treatments of \(\mathcal N=1\) and \(\mathcal N=2\) gauge dynamics.
\end{openproblem}
