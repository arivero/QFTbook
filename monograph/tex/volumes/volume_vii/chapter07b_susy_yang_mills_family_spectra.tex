...
color-factor comparison coordinate.  In the monograph they are comparison
functions for
comparison unless a chapter supplies a derivation in a specified QFT
framework.

\begin{proposition}[Finite algebra of the two \(k\)-string comparisons]
\label{prop:k-string-tension-algebra}
For \(1\le k\le N_c-1\),
\[
...
\[
  (N_c-k)k=k(N_c-k).
\]
For the sine-law comparison, expand
\[
  \sin\frac{\pi k}{N_c}
  =
  \frac{\pi k}{N_c}
...
\begin{proposition}[What the Abelian sine calculation transfers]
\label{prop:abelian-sine-transfer-status}
...
\begin{proof}
The first assertion is the elementary continuity of a quotient whose
