...
Gauss hypergeometric functions expresses the same two-dimensional solution
space in the \(z=1\) fusion basis.  Crossing symmetry of the four-point
function with one degenerate insertion identifies the products of OPE
coefficients in the two bases, giving
