...
\newcommand{\ChapterConventions}[5]{%
  ...
  \begin{itemize}[leftmargin=1.6em,itemsep=0pt,topsep=0.15em,parsep=0pt]
    ...
    \item \textbf{Global guide.} Recurrent symbols, overload warnings, and
    standing sign conventions are collected in
    \hyperref[ch:notation-convention-guide]{the Notation and Convention Guide};
    the local definitions in this chapter fix the operative meaning.
  \end{itemize}
}
