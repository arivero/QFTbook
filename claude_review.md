...
| [#703](https://github.com/xiyin137/QFT/issues/703) | Statmech-to-QFT absorption crosswalk. Partial: nonequilibrium finite path-measure/MSRJD/Doi-Peliti/large-deviation layers, hydrodynamic Kubo/Mori closure datum, finite-locality/TQFT laboratories, numerical-evidence certificates, HMC/RHMC diagnostics, and constructive polymer source-cumulant bridge. Remaining: dynamic critical models, deeper hydrodynamic theorem-status/GHD bridge, tensor-network/neural continuum-control examples, constructive model-specific polymer bounds, and further finite-locality/Hall/TQFT stability work |
---
