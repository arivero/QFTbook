...
11. **All-loop cusp via BES, with QCD/DIS cross-link** (Xi 2026-05-27) — full BES-equation development + weak/strong expansions + Bremsstrahlung function. Vol II ch19 needs an explicit QCD-cusp section (large-spin twist-2 universal logs, Wilson-line/eikonal interpretation) to which the planar N=4 BES result cross-refers. See [#624](https://github.com/xiyin137/QFT/issues/624).
...
| [#519](https://github.com/xiyin137/QFT/issues/519) | Energy-correlator section — partial: tree-level collinear EEC coefficient added (Vol II ch19, calc-check passes). Remaining: full modern program (Moult/Zhiboedov/Korchemsky/Kravchuk/Simmons-Duffin); ANEC/light-ray-OPE; conformal-collider derivation | IV |
...
| [#597](https://github.com/xiyin137/QFT/issues/597) | **Block N**: monopole + instanton chapters still owed. Partial: soliton collective-coordinate measure, monopole phase-coordinate dyon/Witten-effect derivation, and universal one-loop BPST density scale/RG factors added | II |
...
| Issue | Remaining work |
|---|---|
| [#624](https://github.com/xiyin137/QFT/issues/624) | Planar N=4: all-loop cusp via BES (weak/strong expansions, Bremsstrahlung, QCD/DIS cross-link); free-magnon + BMN start of spin-chain; classical curve / finite-gap; Pohlmeyer; Konishi 4-loop wrapping; TBA↔QSC equivalence. Yangian removed; hexagon kept with scrutiny-bar |
...
| [#630](https://github.com/xiyin137/QFT/issues/630) | QCD rigor uplift — remaining subclusters: SCET, HQET/NRQCD, QCD sum rules, Drell-Yan factorization, BFKL, GPD/TMD, Gribov-Zwanziger, Eguchi-Kawai, refined jet factorization, lattice quasi-PDF, hydrodynamics-from-QCD. (θ/WV/CFL/HTL/NFL done in Vol X ch12 + Vol II ch20/21) |
| [#631](https://github.com/xiyin137/QFT/issues/631) | Lattice — remaining: dynamical-fermion HMC; SLURM/MPI launch wrappers; glueball GEVP; SDPB bootstrap workflow. (Axis A theory + SU(3) pure-gauge pipeline with HDF5/checkpoint/theorem-anchor/calc-check delivered + verified.) Higher-standard mandate: teaching-repo as inspiration only |
...
2. **Active development**: [#597](https://github.com/xiyin137/QFT/issues/597) (monopole + instanton chapters), [#596](https://github.com/xiyin137/QFT/issues/596) (light-front + 't Hooft + CS-matter), [#608](https://github.com/xiyin137/QFT/issues/608)/[#582](https://github.com/xiyin137/QFT/issues/582)/[#581](https://github.com/xiyin137/QFT/issues/581) (SPDE Φ⁴_3), [#631](https://github.com/xiyin137/QFT/issues/631) remaining (dynamical-fermion HMC + SLURM/MPI wrappers + glueball GEVP + SDPB bootstrap), [#494](https://github.com/xiyin137/QFT/issues/494) (Vol XI numerical-methods integration), [#505](https://github.com/xiyin137/QFT/issues/505) (rigorous RG).
