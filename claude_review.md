...
| Issue | Remaining work |
|---|---|
| [#624](https://github.com/xiyin137/QFT/issues/624) | Planar N=4: all-loop cusp via BES deeper pass (higher weak/strong expansions, Bremsstrahlung); classical curve / finite-gap; Pohlmeyer; Konishi 4-loop wrapping; TBA↔QSC equivalence. Delivered on this lane: QCD/DIS cusp cross-link in Vol II ch19 + Vol VII ch13; free-magnon/BMN spin-chain entry in Vol VII ch12 with finite-chain `p=2 pi n/(L-1)` derivation and calc-check. Yangian removed; hexagon kept with scrutiny-bar |
