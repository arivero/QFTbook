...
| Issue | Remaining work |
|---|---|
| [#624](https://github.com/xiyin137/QFT/issues/624) | Planar N=4: all-loop cusp via BES deeper pass (higher weak/strong expansions, Bremsstrahlung); free-magnon + BMN start of spin-chain; classical curve / finite-gap; Pohlmeyer; Konishi 4-loop wrapping; TBA↔QSC equivalence. QCD/DIS cusp cross-link now delivered in Vol II ch19 + Vol VII ch13. Yangian removed; hexagon kept with scrutiny-bar |
