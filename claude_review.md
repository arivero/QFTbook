...
| [#630](https://github.com/xiyin137/QFT/issues/630) | QCD rigor uplift — partial: SCET, HQET/NRQCD, Drell-Yan/Glauber, BFKL, GPD/TMD, lattice quasi-/pseudo-PDF matching, QCD current sum rules, and Eguchi--Kawai volume-reduction hypotheses/center-selection now have operator-level rigorous starts with calculation checks. Remaining subclusters: Gribov-Zwanziger, refined jet factorization, CGC/JIMWLK, stronger SCET/Glauber proofs, exact CS-matter solution layer, hydrodynamics-from-QCD. (θ/WV/CFL/HTL/NFL done in Vol X ch12 + Vol II ch20/21) |
