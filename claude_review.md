...
| [#694](https://github.com/xiyin137/QFT/issues/694) | Vol VI nested Bethe ansatz / TQ-relations / separation-of-variables depth gap. Remaining: replace thin structural prose in ch04b/ch05b by theorem-level \(Y(\mathfrak{sl}_N)\) monodromy and RTT material, nested transfer-matrix analyticity, T-/Q-/QQ-systems, Hirota dynamics, SoV covectors/measures, and worked models with calculation checks |
