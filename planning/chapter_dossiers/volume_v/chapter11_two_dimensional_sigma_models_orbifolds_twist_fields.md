...
24. For a cycle type
   ...
   Hilbert spaces.
25. The symmetric-product partition-function generating series is the
...
26. Twist OPEs multiply monodromies before conjugacy-class averaging; a
...
27. Twist-field deformations are conformal perturbations by projected local
...
- `calculation-checks/nlsm_weyl_anomaly_checks.py` verifies the rational
  ...
  Bianchi coefficient, and heterotic gauge/dilaton redundant direction.
