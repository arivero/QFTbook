#!/usr/bin/env python3
"""Audit theorem-family headings for scope-negation framing.
...
is being proved.  It does not try to judge proof quality; it flags the
presentation pattern that creates fake-looking proofs.
"""
...
def main() -> int:
    ...
    if failures:
        print("Theorem-family headings framed as scope negations:", file=sys.stderr)
