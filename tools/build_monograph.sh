...
FINAL_LOG_ISSUE_PATTERN="(^!|LaTeX Error|Package [A-Za-z]+ Error|Emergency stop|Fatal error|Undefined control sequence|Reference .* undefined|Citation .* undefined|Missing .* inserted|Overfull|Underfull|already defined|multiply defined|xdvipdfmx:warning)"
BUILD_LOG_FATAL_PATTERN="(^!|LaTeX Error|Package [A-Za-z]+ Error|Emergency stop|Fatal error|Undefined control sequence|Missing .* inserted|xdvipdfmx:warning)"
