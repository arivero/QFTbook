...
- `wightman_net_bridge_checks.py`: exact rational finite-matrix checks for
  ...
  Finally, it checks the finite additivity/covariance shadow used in the
  Wightman-to-net bridge: the spectral projections of a noncommuting sum
  ...
  transports those projections to the transformed summed generator.
