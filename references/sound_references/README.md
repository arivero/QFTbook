# Sound Reference Shelf

This shelf contains downloaded external references for theorem boundaries and
framework comparison. These references do not determine the monograph's order.
Each use in the manuscript must be attached to a specific claim, framework, and
hypothesis list.

## Current Files

| File | Reference | Planned role |
| --- | --- | --- |
| `fewster_rejzner_aqft_intro_1904.04051.pdf` | Christopher J. Fewster and Kasia Rejzner, "Algebraic Quantum Field Theory -- an introduction", arXiv:1904.04051 | AQFT local nets, GNS, spectrum condition, Reeh--Schlieder, superselection context. |
...
| `bilal_lectures_on_anomalies_0802.0634.pdf` | Adel Bilal, "Lectures on Anomalies", arXiv:0802.0634 | Chiral anomalies, anomalous Ward identities, consistent versus covariant anomalies, descent equations, anomaly polynomials, and index-theorem normalization. |
| `witten_fermion_path_integrals_topological_phases_1508.04715.pdf` | Edward Witten, "Fermion Path Integrals And Topological Phases", arXiv:1508.04715 | Fermion Pfaffians, determinant/Pfaffian line bundles, global anomalies, mapping tori, eta invariants, and mod-two indices. |
| `leutwyler_foundations_chiral_perturbation_hep-ph_9311274.pdf` | H. Leutwyler, "On the foundations of chiral perturbation theory", arXiv:hep-ph/9311274 | Current generating functionals, Ward identities with external fields, Goldstone effective actions, spurions, and Wess--Zumino terms in chiral perturbation theory. |
...
| `straumann_poincare_representations_0809.4942.pdf` | Norbert Straumann, "Unitary Representations of the inhomogeneous Lorentz Group and their Significance in Quantum Physics", arXiv:0809.4942 | Wigner--Mackey representation theory and particle-state classification. |

## Use Rule

Before citing one of these references in the monograph, record in the relevant
chapter dossier:

- exact theorem, definition, section, or page being used;
